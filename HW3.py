# Your name: Jack Kelke
# Your student id: 3896 2043
# Your email: jackkelk@umich.edu
# Who or what you worked with on this homework (including generative AI like ChatGPT): ChatGPT
# If you worked with generative AI also add a statement for how you used it.  Helped define functions and debug problems within function defs.
# e.g.: 
...
class DigitalBookofAnswers():
    ...
    def check_get_answer(self, question):
        ...
        # Pick a random answer if it's a new question
    ...
    def answer_log(self):
        ...
        freq = {}
        for idx in self.answered_list:
            answer = self.book_answer_list[idx].lower()
            if answer in freq:
                freq[answer] += 1
            else:
                freq[answer] = 1
        ...
        return [f"{count} - {answer}" for answer, count in sorted_freq]
